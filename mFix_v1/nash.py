...
def repNashConcComposites(model, north_ave_conc, valley_ave_conc, south_ave_conc):
    ...
    1) Get the mean for each soil composite for entire year (initial.csv)
    North = 2... ug/g soil
    Talweg = 2... ug/g soil
    South = 2... ug/g soil
...
def reptNashIsoComposites(model, north_ave_iso, valley_ave_iso, south_ave_iso):
    ...
    #nash_compIso = 1 - ((model.northIso_diff / model.northIso_var) * 1 / 3 +
    #                       (model.valleyIso_diff / model.valleyIso_var) * 1 / 3 +
    #                       (model.southIso_diff / model.southIso_var) * 1 / 3)
