...
def defineHydroTSS(model):
    ...
    model.resW_accRain_m3_tss = TimeoutputTimeseries("resW_accRain_m3", model, nominal("maps\\static\\outlet"),
                                                     noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    # GA infiltration
    ...
    model.resW_o_cumDrain_m3_tss = TimeoutputTimeseries("resW_o_cumDrain_m3", model, nominal("maps\\static\\outlet"),
                                                        noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Cumulative ADR
    # LF options
    ...
    model.resW_outLatflow_m3_tss = TimeoutputTimeseries("resW_outLatflow_m3", model, nominal("maps\\static\\outlet"),
                                                        noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Outlet LF
    ...
    model.q_obs_cum_tss = TimeoutputTimeseries("resW_cum_q_obs_m3", model, nominal("maps\\static\\outlet"),
                                               noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Equivalent to net_Q
    ...
    model.rest_obs_tss = TimeoutputTimeseries("resW_q_restit_obs_m3", model, nominal("maps\\static\\outlet"),
                                              noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # = rain/q_obs
    model.q_sim_cum_tss = TimeoutputTimeseries("resW_cum_q_sim_m3", model, nominal("maps\\static\\outlet"),
                                               noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Sum sim discharge (if obs available).
    model.q_sim_ave_tss = TimeoutputTimeseries("resW_q_sim_ave_m3", model, nominal("maps\\static\\outlet"),
                                               noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # This is 'Nash_q' as time series.
...
def definePestTSS(model):
    ...
    model.resM_accROz0_tss = TimeoutputTimeseries("resM_accROz0", model, nominal("maps\\static\\outlet"),
                                                  noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resM_accROz0nor_tss = TimeoutputTimeseries("resM_accROz0nor", model, nominal("maps\\sampling\\north_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resM_accROz0val_tss = TimeoutputTimeseries("resM_accROz0val", model, nominal("maps\\sampling\\valley_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resM_accROz0sou_tss = TimeoutputTimeseries("resM_accROz0sou", model, nominal("maps\\sampling\\south_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    ...
    model.resM_accDEGz0val_tss = TimeoutputTimeseries("resM_accDEGz0val", model, nominal("maps\\sampling\\valley_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resM_accDEGz0sou_tss = TimeoutputTimeseries("resM_accDEGz0sou", model, nominal("maps\\sampling\\south_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    ...
    model.resM_accLCHz0val_tss = TimeoutputTimeseries("resM_accLCHz0val", model, nominal("maps\\sampling\\valley_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resM_accLCHz0sou_tss = TimeoutputTimeseries("resM_accLCHz0sou", model, nominal("maps\\sampling\\south_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")

    model.resM_accLCHz1_tss = TimeoutputTimeseries("resM_accLCHz1", model, nominal("maps\\static\\outlet"),
                                                   noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")

    model.resM_accDP_tss = TimeoutputTimeseries("resM_accDP", model, nominal("maps\\static\\outlet"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resM_accADR_tss = TimeoutputTimeseries("resM_accADR", model, nominal("maps\\static\\outlet"),
                                                 noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resM_accLF_tss = TimeoutputTimeseries("resM_accLF", model, nominal("maps\\static\\outlet"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resM_accBF_tss = TimeoutputTimeseries("resM_accBF", model, nominal("maps\\static\\outlet"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    ...
    model.resM_EXP_light_g_tss = TimeoutputTimeseries("resM_EXP_light_g", model, nominal("maps\\static\\outlet"),
                                                      noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Total outlet mass (g) exports (light fraction only)
    model.resM_EXP_heavy_g_tss = TimeoutputTimeseries("resM_EXP_heavy_g", model, nominal("maps\\static\\outlet"),
                                                      noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Total outlet mass (g) exports (heavy fraction only)
    # Concentrations outlet
    model.resM_oCONC_ugL_tss = TimeoutputTimeseries("resM_oCONC_ugL", model, nominal("maps\\static\\outlet"),
                                                    noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Total outlet conc (ug/L)
    model.resM_oCONC_ROFF_ugL_tss = TimeoutputTimeseries("resM_oCONC_ROFF_ugL", model,
                                                         nominal("maps\\static\\outlet"),
                                                         noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Runoff outlet conc (ug/L)
    model.resM_oCONC_LF_ugL_tss = TimeoutputTimeseries("resM_oCONC_LF_ugL", model, nominal("maps\\static\\outlet"),
                                                       noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Latflow outlet conc (ug/L)

    model.resM_oCONC_ADR_ugL_tss = TimeoutputTimeseries("resM_oCONC_ADR_ugL", model, nominal("maps\\static\\outlet"),
                                                        noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Artificial drainage outlet conc (ug/L)
    # Isotopes outlet
    ...
    model.resM_outISO_ROFF_d13C_tss = TimeoutputTimeseries("resM_outISO_ROFF_d13C", model,
                                                           nominal("maps\\static\\outlet"),
                                                           noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Runoff outlet
    model.resM_outISO_LF_d13C_tss = TimeoutputTimeseries("resM_outISO_LF_d13C", model,
                                                         nominal("maps\\static\\outlet"),
                                                         noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Latflow outlet
    model.resM_outISO_ADR_d13C_tss = TimeoutputTimeseries("resM_outISO_ADR_d13C", model,
                                                          nominal("maps\\static\\outlet"),
                                                          noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Artificial drainage outlet

    # Cumulative Pesticide
    model.cum_degZ0_g_tss = TimeoutputTimeseries("resM_cumDEGz0", model, nominal("maps\\static\\outlet"),
                                                 noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Deg z0
    ...
    model.resM_cumLCHz0_L_g_tss = TimeoutputTimeseries("resM_cumLCHz0_L", model, nominal("maps\\static\\outlet"),
                                                       noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Leaching z0
    model.cum_roZ0_L_g_tss = TimeoutputTimeseries("resM_cumROz0_L", model, nominal("maps\\static\\outlet"),
                                                  noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Runoff
    ...
    model.cum_adr_L_g_tss = TimeoutputTimeseries("resM_cumADR_L", model, nominal("maps\\static\\outlet"),
                                                 noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Art. drainage
    model.cum_latflux_L_g_tss = TimeoutputTimeseries("resM_cumLF_L", model, nominal("maps\\static\\outlet"),
                                                     noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Soil column, outlet cells

    model.resM_cumEXP_Smet_g_tss = TimeoutputTimeseries("resM_cumEXP_Smet_g", model, nominal("maps\\static\\outlet"),
                                                        noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")  # Total cum. outlet mass (g) exports
...
def defineTopSoilConditions(model):
    ...
    model.resW_z0_theta_val = TimeoutputTimeseries("resW_z0_theta_val", model, nominal("maps\\sampling\\valley_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resW_z0_theta_sou = TimeoutputTimeseries("resW_z0_theta_sou", model, nominal("maps\\sampling\\south_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")

    model.resW_z1_theta_nor = TimeoutputTimeseries("resW_z1_theta_nor", model, nominal("maps\\sampling\\north_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resW_z1_theta_val = TimeoutputTimeseries("resW_z1_theta_val", model, nominal("maps\\sampling\\valley_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resW_z1_theta_sou = TimeoutputTimeseries("resW_z1_theta_sou", model, nominal("maps\\sampling\\south_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")

    model.resW_z2_theta_nor = TimeoutputTimeseries("resW_z2_theta_nor", model, nominal("maps\\sampling\\north_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resW_z2_theta_val = TimeoutputTimeseries("resW_z2_theta_val", model, nominal("maps\\sampling\\valley_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resW_z2_theta_sou = TimeoutputTimeseries("resW_z2_theta_sou", model, nominal("maps\\sampling\\south_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    ...
    model.resW_z0_temp_val = TimeoutputTimeseries("resW_z0_temp_val", model, nominal("maps\\sampling\\valley_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resW_z0_temp_sou = TimeoutputTimeseries("resW_z0_temp_sou", model, nominal("maps\\sampling\\south_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")

    model.resW_z1_temp_nor = TimeoutputTimeseries("resW_z1_temp_nor", model, nominal("maps\\sampling\\north_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resW_z1_temp_val = TimeoutputTimeseries("resW_z1_temp_val", model, nominal("maps\\sampling\\valley_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resW_z1_temp_sou = TimeoutputTimeseries("resW_z1_temp_sou", model, nominal("maps\\sampling\\south_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")

    model.resW_z2_temp_nor = TimeoutputTimeseries("resW_z2_temp_nor", model, nominal("maps\\sampling\\north_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resW_z2_temp_val = TimeoutputTimeseries("resW_z2_temp_val", model, nominal("maps\\sampling\\valley_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
    model.resW_z2_temp_sou = TimeoutputTimeseries("resW_z2_temp_sou", model, nominal("maps\\sampling\\south_ave"), noHeader=False, save_path="tss\\output\\" + str(model.period) + "\\")
