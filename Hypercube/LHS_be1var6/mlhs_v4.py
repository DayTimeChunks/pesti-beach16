...
This version is for models ending with versions "6", like: fix6+ and var6+
The changes in this version include narrower boundaries to hydrological parameters
based on Q-NSE results.
