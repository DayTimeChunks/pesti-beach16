...
from mlhs_v15 import *  # Defines the LHS sampling problem

from applications_2x import getApplications
...
"""
For Gen11 tests.
Considers 7 application days, two farmers apply twice, 
Burger and Kopp triple dosages (instead of double as base-line)
"""
...
class BeachModel(DynamicModel, MonteCarloModel):
    ...
    def premcloop(self):
        ...
        self.is_north = defined(readmap("norArea"))
        self.is_valley = defined(readmap("valArea"))
        self.is_south = defined(readmap("souArea"))
    ...
    def dynamic(self):
        ...
        self.cover_frac = timeinputscalar('cover_frac.tss', nominal(self.landuse))
        ...
        for layer in range(self.num_layers):
            ...
            #     self.report(self.temp_fin[layer], 'd14Tz' + str(layer))
            # elif self.currentTimeStep() == 166:
            #     self.report(self.temp_fin[layer], 'd166Tz' + str(layer))

            # self.report(self.temp_fin[layer], 'temp_z'+str(layer))
            # self.report(self.temp_surf_fin, 'tsurf_z'+str(layer))
            # aguila --scenarios='{1}' --timesteps=[1,300,1] temp_z0 temp_z1
