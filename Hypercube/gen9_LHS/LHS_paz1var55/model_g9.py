...
from mlhs_v14 import *  # Defines the LHS sampling problem

from applications_v3b import getApplications
from hydro_v3 import *
from pesti_v3 import *
...
class BeachModel(DynamicModel, MonteCarloModel):
    ...
    def dynamic(self):
        ...
        for layer in range(self.num_layers):
            ...
            if layer < 2:
                if layer == 1:
                    pot_evapor_layer = pot_evapor * self.f_evap
                else:
                    pot_evapor_layer = pot_evapor * (1 - self.f_evap)
