...
from mlhs_v12 import *  # Defines the LHS sampling problem
...
"""
Gen7:
 - corrects for 5 days volatilization
 - Computes mean variable DT50 for catchment areas (Transects)
 - Maximum and minimum catchment
