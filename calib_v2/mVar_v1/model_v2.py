...
# morris = False
# if morris:
#     from morris.morris_test import *
# else:
#     runs = 3
...
class BeachModel(DynamicModel):
    ...
    def initial(self):
        ...
        self.resW_accRain_m3_tss = TimeoutputTimeseries("resW_accRain_m3", self, nominal(self.outlet_path), noHeader=False)
        # Runoff
        self.resW_accRunoff_m3_tss = TimeoutputTimeseries("resW_accRunoff_m3", self, nominal(self.outlet_path),
                                                          noHeader=False)
        self.tot_runoff_m3_tss = TimeoutputTimeseries("resW_totRunoff_m3", self, nominal(self.outlet_path), noHeader=False)
        # Percolation
        self.resW_accPercol_Bsmt_m3_tss = TimeoutputTimeseries("resW_accPercol_Bsmt_m3", self, nominal(self.outlet_path),
                                                               noHeader=False)
        # Deep percolation Basement
        self.tot_perc_z3_m3_tss = TimeoutputTimeseries("resW_totPercol_z3_m3", self, nominal(self.outlet_path),
                                                       noHeader=False)
        # ETP
        self.resW_accEtp_m3_tss = TimeoutputTimeseries("resW_accEtp_m3", self, nominal(self.outlet_path), noHeader=False)
        ...
        self.global_mb_water_tss = TimeoutputTimeseries("resW_global_waterMB", self, nominal(self.outlet_path),
                                                        noHeader=False)
        self.storage_m3_tss = TimeoutputTimeseries("resW_accStorage_m3", self, nominal(self.outlet_path), noHeader=False)
        ...
        self.resM_accVOLAT_L_tss = TimeoutputTimeseries("resM_accVOLAT_L", self, nominal(self.outlet_path), noHeader=False)
        ...
        self.resM_accAGED_L_tss = TimeoutputTimeseries("resM_accAGED_L", self, nominal(self.outlet_path), noHeader=False)
        self.resM_accAGED_DEG_L_tss = TimeoutputTimeseries("resM_accAGED_DEG_L", self, nominal(self.outlet_path),
                                                           noHeader=False)
        self.resM_accDEGz0_L_tss = TimeoutputTimeseries("resM_accDEGz0_L", self, nominal(self.outlet_path), noHeader=False)
        self.resM_accLCHz0_L_tss = TimeoutputTimeseries("resM_accLCHz0_L", self, nominal(self.outlet_path), noHeader=False)
        self.resM_accDPz1_L_tss = TimeoutputTimeseries("resM_accDPz1_L", self, nominal(self.outlet_path), noHeader=False)
        ...
        if self.NASH:
            self.nashN_compConc_L_tss = TimeoutputTimeseries("nashN_compConc_L", self, nominal("mapAnalysis/north_ave"),
                                                             noHeader=False)
            self.nashV_compConc_L_tss = TimeoutputTimeseries("nashV_compConc_L", self, nominal("mapAnalysis/valley_ave"),
                                                             noHeader=False)
...
# if __name__ == '__main__':
    # model_v2.py executed as script
    # do something
