...
def repNashConcComposites(model, north_ave_conc, valley_ave_conc, south_ave_conc):
    ...
    """
    # Nash
    conc_north_obs = timeinputscalar('tssAnalysis/northConc.tss', ordinal("north_ave"))
    ...
    # Nash
    conc_valley_obs = timeinputscalar('tssAnalysis/valleyConc.tss', ordinal("valley_ave"))
    ...
    conc_south_obs = timeinputscalar('tssAnalysis/southConc.tss', ordinal("south_ave"))
    ...
    model.nashN_compConc_L_tss.sample(north_nash_compConc)  # report on north_ave.map
    model.nashV_compConc_L_tss.sample(valley_nash_compConc)
    model.nashS_compConc_L_tss.sample(south_nash_compConc)
...
def reptNashIsoComposites(model, north_ave_iso, valley_ave_iso, south_ave_iso):
    iso_north_obs = timeinputscalar('tssAnalysis/northDelta.tss', ordinal("north_ave"))
    ...
    iso_valley_obs = timeinputscalar('tssAnalysis/valleyDelta.tss', ordinal("valley_ave"))
    ...
    iso_south_obs = timeinputscalar('tssAnalysis/southDelta.tss', ordinal("south_ave"))
    ...
    model.nashN_compIso_tss.sample(north_nash_compIso)
    model.nashV_compIso_tss.sample(valley_nash_compIso)
    model.nashS_compIso_tss.sample(south_nash_compIso)
