...
class BeachModel(DynamicModel, MonteCarloModel):
    ...
    def dynamic(self):
        ...
        self.theta_sat[0] = timeinputscalar('tssInput/thetaSat_agr.tss',
                                            nominal(self.landuse))  # saturated moisture # [-]
        self.theta_sat[1] = deepcopy(self.theta_sat[0])
        self.theta_fc[0] = timeinputscalar('tssInput/thetaFC_agr.tss',
                                           nominal(self.landuse)) * self.fc_adj  # field capacity
