...
#  aguila --scenarios='{2}' --timesteps=[1,300,1] Ksatz0 Ksatz1 Ksatz2 Ksatz3
...
def recordLCH(model, leachate, layer):
    model.report(leachate, 'aLCHz' + str(layer))

#  aguila --scenarios='{2}' --timesteps=[2,300,2] aLCHz0 aLCHz1 aLCHz2 aLCHz3 outlet_multi_nom_v3.map
...
# aguila --scenarios='{2}' --timesteps=[1,300,1] aROmm
