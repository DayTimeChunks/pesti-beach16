...
class BeachModel(DynamicModel, MonteCarloModel):
    ...
    def dynamic(self):
        ...
        global_mb_water = tot_rain_m3 - out_runoff_m3 - out_percol_m3 - out_etp_m3 + n_latflow_m3 - out_ch_storage_m3
        ...
        net_vol_disch_m3 = out_runoff_m3 + n_latflow_m3  # <- changed from: net_latflow_m3
