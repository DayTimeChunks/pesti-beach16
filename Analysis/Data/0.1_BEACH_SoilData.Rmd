...
T4 = subset(detailed, is.na(TrPlot) | TrPlot == "T4")
T5 = subset(detailed, is.na(TrPlot) | TrPlot == "T5")
T7 = subset(detailed, is.na(TrPlot) | TrPlot == "T7")
T8 = subset(detailed, is.na(TrPlot) | TrPlot == "T8")
T9 = subset(detailed, is.na(TrPlot) | TrPlot == "T9")
T10 = subset(detailed, is.na(TrPlot) | TrPlot == "T10")
